...
# 跑测试 (97/97 全部通过, 含 8 M5.1 + 4 M5.1b + 4 M5.1c + 7 M5.1d)
...
测试计数: 当前 **97/97** (2.31s)。低于此数 → 有回归; 高于此数 → 新测试已加。
